...
if (isset($_POST['btn_submit'])) {
    ...
    $sql0 = mysqli_query($conn, "SELECT educational_background_tbl.eb_id_number FROM intern_tbl INNER JOIN educational_background_tbl ON intern_tbl.i_id = educational_background_tbl.i_id WHERE educational_background_tbl.eb_id_number='".$_POST['eb_id_number']."'");
