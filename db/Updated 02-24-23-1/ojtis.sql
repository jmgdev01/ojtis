...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2023 at 05:09 PM
...
(1, 'intern@gmail.com', '123456', 'intern', '2023-02-20', 1, 1, NULL, 1, 1),
...
(1, 'Kem Gallo', '../../assets/profile/maxresdefault.jpg', '09123456789');
...
INSERT INTO `configuration_tbl` (`cf_id`, `cf_subject_code`, `cf_subject`, `cf_hours`, `cf_hours_inwords`, `cf_week_equivalent`, `cf_start_date`, `cf_period`, `cf_address`, `cf_campus`, `cf_school`, `cf_department`, `cf_program`) VALUES
(1, 'Practicum 000', 'Practicum/Internship', 500, 'Five Hundred', '3 months and 3 weeks', '2023-02-13', '22-2', 'Alaguisoc, Jordan, Guimaras', 'Mosqueda Campus', 'Guimaras State University', 'College of Science and Technology', 'Bachelor of Science in Information Technology');
...
(1, 'San Isidro Elementary School', 2012, 'Agsanayan National High School', 2015, 'Guimaras State College', 2019, 'BSIT', 'Bachelor of Science in Information Technology', 4, 'C', 'Information Technology', 'GSC-15-0437', 1);
...
(1, 'IN_230220_0001', 'John Michael', 'Navanes', 'Gadot', 'Jr.', '', 'Male', 'Single', 172, 52, '1999-02-01', 24, 'Iloilo City, Iloilo', 'Filipino', 'Graphic Design; Web Development; Database Management;', 'Python Programming (DICT Region IV); User Experience Design (STI Manila);', 0);
...
(1, 'JAMES RYAN B. GA, MIT', 'OJT Instructor', 'Guimaras State University', 'SIMEON J. CAINDAY III, Ph.D.', 'Dean, College of Science and Technology', 'Guimaras State University', 'RUBY D. CATALAN, Ph.D.', 'Vice President for Academic Affairs', 'Guimaras State University', 'LILIAN DIANA B. PARREÑO, Ph.D.', 'University President', 'Guimaras State University', 1);
...
(1, 'Adrian', 'Jaleco', 'Forca', 'Jr.', 'MIT', '../../assets/profile/12406.jpg', 'Male', '09123456789', 'Guimaras State University - Salvador Campus', 'ICT Office', 'ICT Director', 'Director');
...
INSERT INTO `trainer_tbl` (`tr_id`, `tr_first_name`, `tr_middle_name`, `tr_last_name`, `tr_suffix_name`, `tr_img`, `tr_mobile`) VALUES
(1, 'Jun Hendrex', '', 'Escarilla', '', '', '');
