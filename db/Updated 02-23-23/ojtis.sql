...
--
-- Host: localhost
-- Generation Time: Feb 23, 2023 at 12:16 AM
...
INSERT INTO `configuration_tbl` (`cf_id`, `cf_period`, `cf_hours`, `cf_hours_inwords`, `cf_week_equivalent`, `cf_start_date`, `cf_address`, `cf_campus`, `cf_school`, `cf_department`, `cf_program`, `cf_subject`, `cf_subject_code`) VALUES
(1, '22-2', 500, 'Five Hundred', '3 months and 3 weeks', '2023-02-13', 'Alaguisoc, Jordan, Guimaras', 'Mosqueda Campus', 'Guimaras State University', 'College of Science and Technology', 'Bachelor of Science in Information Technology', 'Practicum/Internship', 'Practicum 000');
...
(1, 'IN_230220_0001', 'John Michael', 'Navanes', 'Gadot', 'Jr.', '', 'Male', 'Single', 1, 1, '2023-02-20', 1, '1', '1', '       1', '1', 0);
...
INSERT INTO `supervisor_tbl` (`s_id`, `s_first_name`, `s_middle_name`, `s_last_name`, `s_suffix_name`, `s_img`, `s_sex`, `s_mobile_no`, `s_agency`, `s_office`, `s_designation`, `s_salutation`) VALUES
(1, 'Adrian', 'Jaleco', 'Forca', '', '', 'Male', '09123456789', 'Guimaras State University', 'ICT Office', 'ICT Director', 'Director');
