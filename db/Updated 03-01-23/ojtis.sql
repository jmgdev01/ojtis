...
--
-- Host: localhost
-- Generation Time: Mar 01, 2023 at 03:07 AM
...
CREATE TABLE `intern_tbl` (
  ...
  `i_character_reference` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `intern_tbl` (`i_id`, `i_code`, `i_first_name`, `i_middle_name`, `i_last_name`, `i_suffix_name`, `i_img`, `i_sex`, `i_civil_status`, `i_height`, `i_weight`, `i_birth_date`, `i_age`, `i_place_birth`, `i_religion`, `i_nationality`, `i_comp_knowledge_skills`, `i_training_seminar`, `i_work_experience`, `i_membership`, `i_character_reference`) VALUES
(1, 'IN_230220_0001', 'John Michael', 'Navanes', 'Gadot', '', '../../assets/profile/calendar--v1.png', 'Male', 'Single', 172, 52, '1999-02-01', 24, 'Iloilo City, Iloilo', 'Roman Catholic', 'Filipino', 'Graphic Design; Web Development; Database Management;', 'Python Programming (DICT Region IV); User Experience Design (STI Manila);', 'Web Developer1', 'Buenavista Municipal Scholarship Program', 'Adrian J. Forca (Director, ICT Office)'),
