...
<head>
    ...
    <title>Agency Training Performance Evaluation (ATPE) - OJT Information System</title>
    <?php include("include/style.php"); ?>
</head>
<body id="page-top">
    <?php 
    include("atpe-section/display-atpe-details.php");
                    ...
                    <div class="col-4">
                       <div class="text_stretch">
                            <div class="text_underline">
                                <strong>
                                    <span>
                                    <?php echo date("F Y", strtotime($res['cf_speriod']))." - ".date("F Y"); ?>
                                    </span>
                                </strong>
                            </div>
                       </div>
