...
<head>
    ...
    <title>List of Supervisors - OJT Information System</title>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body pb-3 px-4">
                        ...
                        <h2 class="text-center card_title"><strong>LIST OF SUPERVISORS</strong></h2>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-condensed table-sm" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php 
                                    $count = 1;
                                    $sql = mysqli_query($db, "SELECT * FROM supervisor_tbl 
                                    INNER JOIN accounts_tbl ON supervisor_tbl.s_id = accounts_tbl.s_id 
                                    WHERE acc_role = 'supervisor' AND acc_id!='$acc_id'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php 
                                                echo $res['s_first_name']." ";
                                                if($res['s_middle_name'] != ''){
                                                    echo substr($res['s_middle_name'], 0, 1).". ";
                                                }
                                                echo $res['s_last_name']; 
                                            ...
                                            <td><?php echo $res['s_agency']; ?></td>
                                            <td><?php echo $res['s_office']; ?></td>
                                            <td><?php echo ucfirst($res['acc_role']); ?></td>
                                            <td class="d_hide">
                                                <div class="row d-flex justify-content-center">
                                                    <button 
                                                    onclick="window.location.href='edit-supervisor.php?user_id=<?php echo $res['acc_id']; ?>'"
                                                    ...
                                                    <form action="view-supervisor.php" method="post">
