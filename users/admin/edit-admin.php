...
<head>
    ...
    <title>Admin Details - OJT Information System</title>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body pb-3 px-4">
                            <h2 class="pb-2 text-center"><strong>ACCOUNT DETAILS</strong></h2>
                                ...
                                <div class="col-lg-7 col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12 text-center">
                                            <button class="form-btn form-btn-md btn-blue" type="submit" name="btn_update"><strong><i class="fa fa-floppy-o" aria-hidden="true"></i> SAVE</strong></button>
                                        </div>
                                    </div>
                                </div>
                            </div>  
                            ...
                            <h2 class="pb-2 pt-3 text-center"><strong>RESET PASSWORD</strong></h2>
                                <div class="col-lg-12">
                                    <div class="d-flex justify-content-center">
                                        <div class="col-lg-6 pt-1">
                                            <form method="post" action="edit-admin.php ?user_id=<?php echo $res0['acc_id']; ?>" class="col-lg-12">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-blue" type="submit" name="btn_save"><i class="fa fa-floppy-o" aria-hidden="true"></i> <strong>RESET</strong></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
