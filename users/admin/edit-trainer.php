    ...
    <div class="container py-5">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-12">
                <div class="row pb-3">
                    <div class="col-lg-12">
                        <button class="form-btn form-btn-sm btn-dark" onclick="window.location.href='view-trainer.php'"><i class="fa fa-arrow-left"></i> Back</button>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body pb-3 px-4">
                        ...
                        <form method="post" action="edit-trainer.php?user_id=<?php echo $res0['acc_id']; ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4 col-md-6">
                                        ...
                                        <input type="text" id="tr_mobile" name="tr_mobile" class="form-control" placeholder="e.g. 0956424564" value="<?php echo $res0['tr_mobile']; ?>" maxlength="14">
                                    </div>
                        ...
                        <div class="d-flex justify-content-start pb-2">
                            <div class="row">
                                <form method="post" action="edit-trainer.php?user_id=<?php echo $res0['acc_id']; ?>">
                                    <div class="col-lg-12">
