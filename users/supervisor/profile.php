<?php
    ...
    if (isset($_POST['btn_save'])) {
        ...
        if (empty($s_first_name) || empty($s_last_name) ||  empty($s_sex) || empty($s_mobile) || empty($s_agency) || empty($s_office) || empty($s_designation) || empty($s_salutation) || empty($file_name)) {
            ...
            $sql1 = mysqli_query($db, "UPDATE supervisor_tbl SET s_first_name='$s_first_name', s_middle_name='$s_middle_name', s_last_name='$s_last_name', s_suffix_name='$s_suffix_name', s_img='$img_store', s_sex='$s_sex', s_mobile='$s_mobile', s_agency='$s_agency', s_office='$s_office', s_designation='$s_designation', s_salutation='$s_salutation' WHERE s_id='$s_id'");
