...
<head>
    ...
    <title>List of Interns - OJT Information System</title>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body pb-3 px-4">
                        ...
                        <h2 class="text-center card_title"><strong>LIST OF INTERNS</strong></h2>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-condensed table-sm" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php 
                                    ...
                                    WHERE acc_role = 'intern' AND acc_id!='$acc_id'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="d_hide">
                                                <div class="row d-flex justify-content-center">
                                                    <button 
                                                    onclick="window.location.href='edit-intern.php?user_id=<?php echo $res['acc_id']; ?>'"
                                                    ...
                                                    <form action="view-intern.php" method="post">
                        ...
                        <div class="card_footer">
                            ...
                            <br><br>
                            <h4 style="margin-bottom: 0;"><strong><?php 
                            echo strtoupper($retrieve_info['s_first_name']);
                            if($retrieve_info['s_middle_name'] != ''){
                                echo ' ' .  strtoupper(substr($retrieve_info['s_middle_name'], 0, 1));
                            }
                            echo ' ' . strtoupper($retrieve_info['s_last_name']);
                            if($retrieve_info['s_suffix_name'] != '') {
                                echo ' ' . $retrieve_info['s_suffix_name'];
                            }
                            ?></strong></h4>
