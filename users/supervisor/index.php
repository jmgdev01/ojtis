<?php
    ...
    $sql = mysqli_query($db, "SELECT * FROM accounts_tbl INNER JOIN supervisor_tbl ON accounts_tbl.s_id = supervisor_tbl.s_id WHERE accounts_tbl.acc_id='$acc_id'");
